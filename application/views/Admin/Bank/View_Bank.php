    ...
    <div class="col-lg-8 p-r-0 title-margin-right">
        <div class="page-header">
            <div class="page-title">
                <h1>Quản Lý Chuyển Khoản Ngân Hàng (vnpay.vn)</h1>
            </div>
        </div>
    </div>
    <!-- /# column -->
        ...
        <div class="page-header">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li><a href="<?php echo base_url('admin/ngan-hang/'); ?>">Ngân Hàng (VNPAY)</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card alert">
            <div class="card-header">
                <h4>Cấu Hình Thông Tin Kết Nối Ví <a href="https://sandbox.vnpayment.vn/devreg" target="_blank">VNPAY.VN</a></h4>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <?php if(isset($detail[0]['Id']) && !empty($detail[0]['Id'])){ ?>
                                <input type="text" class="form-control" placeholder="Terminal ID *" name="id" value="<?php echo $detail[0]['Id']; ?>">
                            <?php }else{ ?>
                                <input type="text" class="form-control" placeholder="Terminal ID *" name="id">
                            <?php } ?>
                        </div>
                        <div class="form-group">
                            <label>Secret Key: </label>
                            <?php if(isset($detail[0]['IdKey']) && !empty($detail[0]['IdKey'])){ ?>
                                <input type="text" class="form-control" placeholder="Secret Key *" name="key" value="<?php echo $detail[0]['IdKey']; ?>">
                            <?php }else{ ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php if(isset($detail[0]['LuuY']) && !empty($detail[0]['LuuY'])){ ?>
                                <textarea class="form-control editor" rows="5" name="luuy" placeholder="Lưu Ý Khi Thanh Toán Ngân Hàng Thông Qua VNPAY *"><?php echo $detail[0]['LuuY']; ?></textarea>
                            <?php }else{ ?> 
                                <textarea class="form-control editor" rows="5" name="luuy" placeholder="Lưu Ý Khi Thanh Toán Ngân Hàng Thông Qua VNPAY *"></textarea>
                            <?php } ?>
                        </div>
                        <div class="form-group">
    ...
    <div class="col-lg-12">
        <div class="card alert">
            <div class="card-header">
                <h4>Danh Sách Lịch Sử Thanh Toán Chuyển Khoản Qua VNPAY</h4>
                <div class="card-header-right-icon">
                    <ul>
                        <li class="card-close" data-dismiss="alert"><i class="ti-close"></i></li>
                    </ul>
