                ...
                <div class="basic-form">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Số Tiền Nạp Tổi Thiểu *" name="naptoithieu">
                        </div>
                        <div class="form-group">
                            <label>Chiết Khấu Khuyến Mãi Khi Đủ Mốc</label>
                            <input type="number" class="form-control" placeholder="Chiết Khấu Khuyến Mãi (%) *" name="phantramkhuyenmai">
                        </div>
                        <br>
                        <div>
